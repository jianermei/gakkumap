...
// Lists are exported separately from boundary geometry.
function setPref() { return loadPrefectureIndex(); }
function setCity() { return loadMunicipalityIndex(); }
function setSchool() { return loadSchoolIndex(); }
